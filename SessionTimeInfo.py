...
class SessionTimeInfo:
    ...
    # Getters and Setters
    def get_start_now(self) -> bool: return self._start_now

    def set_start_now(self, sn : bool): self.start_now = sn

    def get_start_date_time(self) -> datetime: return self._start_date_time

    def set_start_date_time(self, dt : datetime): self._start_date_time = dt

    def get_end_when_done(self) -> bool: return self._end_when_done

    def set_end_when_done(self, ewd : bool): self._end_when_done = ewd

    def get_end_date_time(self) -> datetime: return self._end_date_time

    def set_end_date_time(self, edt : datetime): self._end_date_time = edt
